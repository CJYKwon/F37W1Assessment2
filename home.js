...
// const canWeDeliver = tasks.filter((deliveryAreaZipCodes) => {
//    if(!deliveryAreaZipCodes.status){
...
// const canWeDeliver = deliveryAreaZipCodes.filter((deliveryAreaZipCodes) => !deliveryAreaZipCodes.status)
