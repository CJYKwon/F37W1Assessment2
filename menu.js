...
const pizza = {
    ...
    popularity: [10],
    rating: [10],
    tags: [`gluten-free`, `original`, `kidsmenu`]
}
...
const foodArr = [
    ...
    },
    {
        price: [80],
        popularity:[98],
        category: `Meat Haters`,
        ratings: [8],
        tags: [`Original`, `Veggie`]
    },
    {
        price: [90],
        popularity:[97],
...
const filteredFood = foodArr.filter((element) => element.tags.includes(`Meat`))
